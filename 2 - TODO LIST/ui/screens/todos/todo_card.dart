...
class TodoCard extends StatelessWidget {
  ...
  //
  TextDecoration? get textDecoration => Todo.completed 
...
class CheckBox extends StatelessWidget {
  ...
  //  Update the widget to disaply both state (completed / not completed) as required
  //
  BoxBorder? get border => checked
  ? null
  : Border.all(width: 2, color: AppTheme.greenColor);
  
  Color? get backbroundColor => checked 
  ? AppTheme.greenColor
  : Colors.white;
